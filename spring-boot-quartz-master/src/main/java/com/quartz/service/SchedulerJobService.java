...
import com.quartz.job.SampleCronJob;
import com.quartz.job.SimpleJob;
import com.quartz.repository.SchedulerRepository;
...
public class SchedulerJobService {
    ...
    public boolean startJobNow(SchedulerJobInfo jobInfo) {
        try {
        	...
        	schedulerRepository.save(getJobInfo);
           ((SchedulerFactoryBean) context.getBean("schedulerFactoryBean")).getScheduler().triggerJob(new JobKey(jobInfo.getJobName(), jobInfo.getJobGroup()));
	...
	private void scheduleNewJob(SchedulerJobInfo jobInfo) {
		try {
			Scheduler scheduler = ((SchedulerFactoryBean) context.getBean("schedulerFactoryBean")).getScheduler();
